...
const CreateSalesTicketModal: React.FC<{
    ...
    const { addSalesTicket, products, salesTickets } = useData();
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Create New Sales Record">
...
const SalesRecordPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            />
            <CreateSalesTicketModal isOpen={isCreateModalOpen} onClose={() => setCreateModalOpen(false)} />
